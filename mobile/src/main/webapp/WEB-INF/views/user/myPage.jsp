...
<section>
	<div class="mypage_card">
		...
		<ul class="mypage_menu">
			...
			<li class="mypage_menu_item"><a href="/user/myqna"><i class="bi bi-question-circle-fill"></i> 나의 문의</a></li>
			<li class="mypage_menu_item"><a href="/cart"><i class="bi bi-bag-fill"></i> 장바구니</a></li>
			<li class="mypage_menu_item"><a href="/delivery"><i class="bi bi-card-checklist"></i> 주문목록</a></li>
